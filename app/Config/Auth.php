...
class Auth extends ShieldAuth
{
    ...
    //     // Set URL custom di session (jika belum diatur sebelumnya)
    //     if (!$session->getTempdata('beforeLoginUrl')) {
    //         $session->setTempdata('beforeLoginUrl', 'admin/dashboard', 300); // 300 detik
    //     }

    //     // Ambil URL dari session atau gunakan default dari setting
    //     $url = $session->getTempdata('beforeLoginUrl') ?? setting('Auth.redirects')['login'];
    ...
    public function loginRedirect(): string
    {
        // Langsung mengarahkan ke URL yang diinginkan tanpa perlu menyimpan di session
